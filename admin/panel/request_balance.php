...
<head>
	...
	<title>Digits Transfer - Request Transfer</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-brown">
			<div class="row">
				<div class="col-sm-6">
					<h1>Load Balance<small>&nbsp; How I load balance in my Digit Transfer account</small></h1>
				</div><!--.col-->				
				<?php
				...
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="request_balance.php" class="active">Load Balance</a></li>
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Guide lines for balance load</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
							...
							<div class="row">
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2" style="color: blue; text-decoration: underline">For Cards & Money Transfer</label>									
									<br/>
									<table border="0">
										<tr>
											<td>
												Step 1: Go to your online bank account.
											</td>	
										</tr>
										<tr>
											<td>
												Step 2: Send money to any of the following bank accounts.
											</td>	
										</tr>
										<tr>
											<td>
												<font style="color: blue;"><i>seb 50011138157</i></font>													
											</td>	
										</tr>
										<tr>
											<td>
												<font style="color: blue;"><i>Nordea 1126 20 16320</i></font>
											</td>	
										</tr>
										<tr>
											<td>
												<font style="color: blue;"><i>Swed bank  8032546634408</i></font>
											</td>	
										</tr>
										<tr>
											<td>
												<font style="color: blue;"><i>Handlsbanken cleaning number 6230  account number673 448 088</i></font>
											</td>	
										</tr>
										<tr>
											<td>
												<font style="color: blue;"><i>Swish 0707866090</i></font>
											</td>	
										</tr>
										<tr>
											<td>
												Step 3: <font style="color: red;">Important! Please add your email {<?=$_SESSION['email']?>} or customer number {<?=$_SESSION['user_id']?>} in your message during bank transaction.</font>
											</td>	
										</tr>		
									</table>
							...
							<div class="row">
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2" style="color: blue;">For Money Transfer</label>									
									<br/>
									<table border="0">
										<tr>
											<td>
										...
										<tr>
											<td>
												Step 2: Send money to following accounts.
											</td>	
										</tr>	
										<tr>
											<td>
												Step 3: <font style="color: red;">Important! Please add your email {<?=$_SESSION['email']?>} in your message during transaction</font>
											</td>	
										</tr>		
									</table>
