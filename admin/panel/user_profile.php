...
include("db_con.php");	
	if ($_POST['form_submitted'] == "form_submitted") {
		$user_update_query	= "UPDATE users SET password = '".$_POST['password']."', first_name = '".$_POST['first_name']."', last_name = '".$_POST['last_name']."', phone1 = '".$_POST['phone1']."',  phone2 = '".$_POST['phone2']."',  address = '".$_POST['address']."',  city = '".$_POST['city']."',  country = '".$_POST['country']."' WHERE id = '".$_POST['id']."' ";								
		$result_user_update	= mysql_query($user_update_query);
	}	
?>
<!DOCTYPE html>
...
<head>
	...
	<title>Digital Word - User profile</title>
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>User Details</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						?>
						<form name="user_profile_form" action="user_profile.php" method="post" class="form-horizontal" >							 
							<div class="row">								
								...
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">Email/username</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<?=$email_address?>&nbsp;
								...
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">Phone 1</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
								...
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">Phone 2</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
								...
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">Balance</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
												<?=$balance?>&nbsp;
								...
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">Photo</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">												
