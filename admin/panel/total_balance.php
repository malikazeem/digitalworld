...
<head>
	...
	<title>Digits Transfer - Total Balance</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-brown">
			<div class="row">
				<div class="col-sm-6">
					<h1>Balance<small>&nbsp;Total balance</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="load_balance.php" class="active">Total Balance</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->	
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Total Balance Details</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">						
						<form name="total_balance_form" action="#" method="post" class="form-horizontal" >							 
							<div class="row">								
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">Total Balance of Users (SEK)</label>
									<div class="col-md-5">
										<div class="inputer">
								...
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">Cards Balance (SEK)</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
											<?php
											$total_cards_balance_query	= "SELECT SUM(purchase_price) FROM cards_collection WHERE status = '0'";	
											$result_total_cards_balance	= mysql_query($total_cards_balance_query);
												while ($row_tatol_cards_balance = mysql_fetch_array($result_total_cards_balance)){
													echo $row_tatol_cards_balance['SUM(purchase_price)'];								
												}	
											?>	
											&nbsp;
											</div>
