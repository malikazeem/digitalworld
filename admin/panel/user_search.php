...
<head>
	...
	<title>Digital Word - Search User</title>
	...
	<div class="content">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="#" class="active">Search User</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Search by Phone Number</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<form name="phone_number_form" action="user_search.php" method="post" class="form-horizontal">							 
							<div class="row">
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">User Phone Number</label>
									<div class="col-md-5">
										<div class="inputer">
							...
							<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<input type="hidden" value="form_submitted1" name="form_submitted1">
										</div>
									</div>
							</div>
							<br/>	
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Search by Customer Number</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						<form name="phone_number_form" action="user_search.php" method="post" class="form-horizontal">							 
							<div class="row">
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">User Customer Number</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
							...
							<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn btn-primary">Search</button>
											<button type="reset" class="btn btn-default bv-reset">Cancel</button>
											<input type="hidden" value="form_submitted2" name="form_submitted2">
										</div>
									</div>
							</div>
							<br/>	
		...
		<?php
		if ($_POST['form_submitted1'] == "form_submitted1") {
			$phone_query	= "SELECT * FROM users WHERE phone1 = '".$_POST['phone_number']."'";	
			$result_phone	= mysql_query($phone_query);
			$num_rows_phone	= mysql_num_rows($result_phone);
				if ($num_rows_phone == 0) {
					$phone_query	= "SELECT * FROM users WHERE phone2 = '".$_POST['phone_number']."'";	
					$result_phone	= mysql_query($phone_query);
				}
		?>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Search Result</h4></div>
					</div>
					<div class="panel-body">
						<table data-toggle="table" data-height="300" data-sort-name="name" data-sort-order="desc">
							<thead>
								<tr>
									...
									<th data-sortable="true" data-sorter="priceSorter">Email</th>
									<th data-sortable="true" data-sorter="priceSorter">Customer No.</th>
									<th data-sortable="true" data-sorter="priceSorter">Phone 1</th>
									<th data-sortable="true" data-sorter="priceSorter">Phone 2</th>
									<th data-sortable="true" data-sorter="priceSorter">Address</th>
									<th data-sortable="true" data-sorter="priceSorter">Balance (SEK)</th>
								</tr>								
							</thead>
							<tbody>
							<?php
							while ($row = mysql_fetch_array($result_phone))  {
								$user_id 		= $row['id'];
							...
							?>
								<tr>
									<td>
										<a href="user_profile.php?id=<?=$user_id?>"><?=$first_name?></a>
									</td>									
									<td>
										<?=$last_name?>
									</td>
									...
									<td>
										<?php
										$balance_query	= "SELECT balance FROM balance WHERE user_id = '".$user_id."'";	
										$result_balance	= mysql_query($balance_query);
										$row_balance	= mysql_fetch_row($result_balance);
										$balance		= $row_balance[0];										
											if ($balance == "") {
												$balance = 0; 
											}
										echo $balance;	
		...
		?>
		<?php
		if ($_POST['form_submitted2'] == "form_submitted2") {
			$customer_number_query	= "SELECT * FROM users WHERE id = '".$_POST['customer_number']."'";	
			$result_customer_number	= mysql_query($customer_number_query);
		?>
				...
				<div class="panel">
					...
					<div class="panel-body">
						<table data-toggle="table" data-height="300" data-sort-name="name" data-sort-order="desc">
							...
							<tbody>
							<?php
							while ($row = mysql_fetch_array($result_customer_number))  {
								$user_id 		= $row['id'];
								$first_name 	= $row["first_name"];
								$last_name		= $row["last_name"];
								$email_address 	= $row["email_address"];
