...
<h2>Hello</h2>
<p>Your friend <?=$_SESSION['email']?> have purchased a new card for you on Digitstransfer. This is your new purchased <b>card</b> from <?=$_SESSION['email']?>. </p>
