...
<head>
	...
	<title>Digital Word - Sold Cards Listing</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-blue-grey">
			<div class="row">
				<div class="col-sm-6">
					<h1>Sold Cards<small>&nbsp;Listing</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="#" class="active">Sold Cards Listing</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Sold Cards Listing</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<?php
						$users_query	= "SELECT * FROM cards_history";	
						...
						<table data-toggle="table" data-height="300" data-sort-name="name" data-sort-order="desc">
							<thead>
								<tr>
									...
									<th data-sortable="true" data-sorter="priceSorter">Card</th>
									<th data-sortable="true" data-sorter="priceSorter">Buyer Name</th>									
									<th data-sortable="true" data-sorter="priceSorter">Buyer Email</th>
									<th data-sortable="true" data-sorter="priceSorter">Purchase Time Date</th>
							...
							while ($row = mysql_fetch_array($result_users))  {
								...
								$users_query2	= "SELECT username, first_name, last_name FROM users WHERE id = '".$user_id."'";	
								$result_users2	= mysql_query($users_query2);
								$row_user		= mysql_fetch_row($result_users2);
								$username		= $row_user[0];
							...
							?>
								<tr>
									...
									<td>
										<img src="<?=$card_image?>" width="282" height="179" />								
									</td>
									<td>
										<?=$full_name?>
									</td>
