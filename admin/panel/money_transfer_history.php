...
<head>
	...
	<title>Digital Word - Money Transfer History</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-blue-grey">
			<div class="row">
				<div class="col-sm-6">
					<h1>Money Transfer <small>&nbsp;History</small></h1>
				</div><!--.col-->				
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="#" class="active">Money Transfer History</a></li>						
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Money Transfer History</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<?php
						$users_query	= "SELECT * FROM money_transaction WHERE user_id = '".$_SESSION['user_id']."' ";	
						...
						<table data-toggle="table" data-height="300" data-sort-name="name" data-sort-order="desc">
							<thead>
								<tr>
									...
									<th data-sortable="true" data-sorter="priceSorter">Request Status</th>
									<th data-sortable="true" data-sorter="priceSorter">Security code</th>
								</tr>								
							</thead>
							<tbody>
							<?php
		...
		<div class="form-actions">
					<div class="row">
						<div class="col-md-12" align="center">
							<a href="dashboard.php"><button type="submit" class="btn btn-primary">Back</button></a>							
						</div>
					</div>
			</div>
