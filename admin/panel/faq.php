			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Frequently Asked Questions</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<form name="faq_form" action="#" method="post" class="form-horizontal">							 
							<div class="row">														
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">Question:</label>
									<div class="col-md-5">
										<div class="inputer">
								...
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">Answer:</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
