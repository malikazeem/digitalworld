...
$card_view 	= "style='display: none;'";
	if ($_POST['form_submitted'] == "form_submitted") {		
		$hash_password				= $_POST['current_password'];				
		$hash_password 				= encryptIt($hash_password);
		$hash_new_password			= $_POST['password'];				
		$hash_new_password			= encryptIt($hash_new_password);
		$current_password_query		= "SELECT password FROM users WHERE id = '".$_SESSION['user_id']."'";	
		$result_current_password	= mysql_query($current_password_query);
		$row 						= mysql_fetch_row($result_current_password);
			if ($row[0] != $hash_password) {
				$message 	= "Current password does not match. Please try again";	
			} else {				
				$change_password_query	= "UPDATE users SET password = '".$hash_new_password."' WHERE id = '".$_SESSION['user_id']."' ";								
				$result_change_password	= mysql_query($change_password_query);
...
<head>
	...
	<title>Digital Word - Change Password</title>
    ...
    var password		= document.forms["change_password_form"]["password"].value;
    var verify_password	= document.forms["change_password_form"]["verify_password"].value;    
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-brown">
			<div class="row">
				<div class="col-sm-6">
					<h1>Password <small>Change Password</small></h1>
				</div><!--.col-->
				<?php
			...
			<div class="col-md-12">
				<div class="panel">
					...
					<div class="panel-body">
						...
						<form name="change_password_form" action="change_password.php" method="post" class="form-horizontal" onsubmit="return validateForm();">							 
							<div class="row">
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">Current Password</label>
									<div class="col-md-5">
										<div class="inputer">
								...
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">New Password</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
								...
								<div class="form-group has-success has-feedback">
									<label class="control-label col-md-3" for="inputSuccess2">Verfiy Password</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper">
