...
$card_view 	= "style='display: none;'";
	if ($_POST['form_submitted'] == "form_submitted") {
		$update_profile_query	= "UPDATE users SET first_name = '".$_POST['first_name']."', last_name = '".$_POST['last_name']."', phone1 = '".$_POST['phone1']."', phone2 = '".$_POST['phone2']."', address = '".$_POST['address']."', city = '".$_POST['city']."', country = '".$_POST['country']."' WHERE id = '".$_SESSION['user_id']."' ";								
		$result_update_profile	= mysql_query($update_profile_query);
...
<head>
	...
	<title>Digitstransfer - Update Profile</title>
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Update Profile</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						...
						?>
						<form name="update_profile_form" action="update_profile.php" method="post" class="form-horizontal">							 
							<div class="row">
