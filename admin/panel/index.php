...
<head>
	...
	<title>Digital Word - User Login</title>
		...
		<div class="panel-login blur-content">
			...
			<div id="pane-login" class="panel-body active">
				...
				<ul class="extra-links">
					<li><a href="forgot_password.php" class="show-pane-forgot-password">Forgot your password</a></li>
					<li><a href="signup.php" class="show-pane-create-account">Create new account/Become Customer</a></li>
				</ul>
				<a href="../../index.php"><button type="button" class="btn btn-success pull-right">Home</button></a>
