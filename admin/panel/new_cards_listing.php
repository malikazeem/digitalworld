...
<head>
	...
	<title>Digital Word - Admin Panel</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-blue-grey">
			<div class="row">
				<div class="col-sm-6">
					<h1>New Cards<small>&nbsp;Listing</small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="new_cards_listing.php" class="active">New Cards Listing</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>New Cards Listing</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<?php
						$users_query	= "SELECT * FROM cards_collection WHERE status = '0'";	
						...
						<table data-toggle="table" data-height="300" data-sort-name="name" data-sort-order="desc">
							<thead>
								<tr>
									...
									<th data-sortable="true" data-sorter="priceSorter">Uploaded Time Date</th>
