...
<head>
	...
	<title>Digital Word - Users Listing</title>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="order_preview.php" class="active">Users Listing</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>User Listing</h4></div>
					</div>
					<?php
					$balance_query	= "SELECT SUM(balance) FROM balance";	
					...
					?>		
					<div class="panel-heading">
						<div class="panel-title"><h4>Total Balance of all Users: <?=$balance?> SEK</h4></div>
					</div>
					<div class="panel-body">
						<?php
						$users_query	= "SELECT * FROM users WHERE status = '1'";	
