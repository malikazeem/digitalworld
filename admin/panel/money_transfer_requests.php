...
<head>
	...
	<title>Digital Word - Money Transfer Requests</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-blue-grey">
			<div class="row">
				<div class="col-sm-6">
					<h1>Money Transfer <small>&nbsp;Requests</small></h1>
				</div><!--.col-->				
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="#" class="active">Money Transfer Requests</a></li>						
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Money Transfer Requests</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<?php
						$users_query	= "SELECT * FROM money_transaction";	
						$result_users	= mysql_query($users_query);
						?>
						<table data-toggle="table" data-height="300" data-sort-name="name" data-sort-order="desc">
							<thead>
								<tr>																		
									<th data-sortable="true" data-sorter="priceSorter">Amount</th>
									<th data-sortable="true" data-sorter="priceSorter">Payment Method</th>
									<th data-sortable="true" data-sorter="priceSorter">Change Status</th>
									<th data-sortable="true" data-sorter="priceSorter">Sender Name</th>
									<th data-sortable="true" data-sorter="priceSorter">Sender Address</th>
									<th data-sortable="true" data-sorter="priceSorter">Sender Phone</th>
									<th data-sortable="true" data-sorter="priceSorter">Sender Country</th>
									<th data-sortable="true" data-sorter="priceSorter">Receiver Name</th>
									<th data-sortable="true" data-sorter="priceSorter">Receiver Address</th>
									<th data-sortable="true" data-sorter="priceSorter">Receiver Phone</th>
									<th data-sortable="true" data-sorter="priceSorter">Receiver Country</th>									
								</tr>								
							</thead>
							<tbody>
							<?php
							...
							?>
								<tr>
									...
									<td>
										<a href="change_money_transfer_request_status.php?id=<?=$request_id?>"><?=$status?></a>							
									</td>
									<td>
										<?=$sender_name?>
									</td>	
