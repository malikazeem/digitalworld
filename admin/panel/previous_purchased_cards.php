...
<head>
	...
	<title>Digital Word - Purchased Cards History</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-blue-grey">
			<div class="row">
				<div class="col-sm-6">
					<h1>Previous Purchased Cards<small>&nbsp;Listing</small></h1>
				</div><!--.col-->				
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="previous_purchased_cards.php" class="active">Previous Purchased Cards Listing</a></li>						
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Purchased Cards History</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">
						<?php
						$users_query	= "SELECT * FROM cards_history WHERE user_id = '".$_SESSION['user_id']."' ";	
						...
						<table data-toggle="table" data-height="300" data-sort-name="name" data-sort-order="desc">
							<thead>
								<tr>
									...
									<th data-sortable="true" data-sorter="priceSorter">Purchased Date Time</th>
								</tr>								
							</thead>
							<tbody>
							<?php
